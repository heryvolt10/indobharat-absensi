...
class M_mt_grade extends Model
{
    use HasFactory, SoftDeletes, LogsActivity;

    protected $table = 'mt_grade';
    ...
    public static function detail($id = null, $onlyquery = null, $filterSearch = null, $filterStatus = null, $formodallist = null)
    {
        ...
        $query = "SELECT A.*, B.nama as status, C.nama as org, CASE WHEN A.i_no_lembur = 1 THEN 'Ya' ELSE '' END as no_lembur
                FROM mt_grade A
