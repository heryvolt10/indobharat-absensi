...
return new class extends Migration
{
    ...
    {
        Schema::create('mt_role_additional', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid');
    ...
    {
        Schema::dropIfExists('mt_role_additional');
        Schema::table('mt_role_additional', function (Blueprint $table) {
