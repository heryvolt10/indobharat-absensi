...
return new class extends Migration
{
    ...
    {
        Schema::create('users_role_additional', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid');
    ...
    {
        Schema::dropIfExists('users_role_additional');
        Schema::table('users_role_additional', function (Blueprint $table) {
            $table->dropForeign(['f_status', 'f_org', 'f_role_additional']);
            $table->dropColumn(['f_status', 'f_org', 'f_role_additional']);
        });
    }
};
