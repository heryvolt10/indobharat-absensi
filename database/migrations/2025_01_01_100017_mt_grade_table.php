...
return new class extends Migration
{
    ...
    {
        Schema::create('mt_grade', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid');
            $table->string('nama')->unique();
            $table->boolean('i_no_lembur')->default(0);
    ...
    {
        Schema::dropIfExists('mt_grade');
        Schema::table('mt_grade', function (Blueprint $table) {
