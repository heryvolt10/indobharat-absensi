...
$(function () {
    ...
    function handleboxedlayout() {
        $("#boxed-layout").on("click", function () {
            ...
            $(this).is(":checked");
            $("html").attr("data-boxed-layout", "boxed");
            $(".label_ly_container_boxed").addClass("pick_set_ly");
            $(".label_ly_container_full").removeClass("pick_set_ly");
        });
        $("#full-layout").on("click", function () {
            $(".container-fluid").addClass("mw-100");
            $("html").attr("data-boxed-layout", "full");
            $(this).is(":checked");
            $(".label_ly_container_boxed").removeClass("pick_set_ly");
            $(".label_ly_container_full").addClass("pick_set_ly");
        });
    }
    handleboxedlayout();
    ...
    function handleTheme() {
        $(".dark-layout").on("click", function () {
            ...
            // $(".moon").hide();
            // $(".sun").show();
            $(".label_ly_theme_light").removeClass("pick_set_ly");
            $(".label_ly_theme_dark").addClass("pick_set_ly");
        });
        $(".light-layout").on("click", function () {
            ...
            // $(".sun").hide();
            // $(".moon").show();
            $(".label_ly_theme_light").addClass("pick_set_ly");
            $(".label_ly_theme_dark").removeClass("pick_set_ly");
        });
    }
    handleTheme();
    ...
    function handlecardlayout() {
        $("#card-with-border").on("click", function () {
            $("html").attr("data-card", "border");
            $(".label_ly_card_border").addClass("pick_set_ly");
            $(".label_ly_card_shadow").removeClass("pick_set_ly");
        });
        $("#card-without-border").on("click", function () {
            $("html").attr("data-card", "shadow");
            $(".label_ly_card_border").removeClass("pick_set_ly");
            $(".label_ly_card_shadow").addClass("pick_set_ly");
        });
    }
    handlecardlayout();
    ...
    function handlesidebartoggle() {
        $("#full-sidebar").on("click", function () {
            $("body").attr("data-sidebartype", "full");
            $(".label_ly_sidebar_full").addClass("pick_set_ly");
            $(".label_ly_sidebar_mini").removeClass("pick_set_ly");
        });
        $("#mini-sidebar").on("click", function () {
            $("body").attr("data-sidebartype", "mini-sidebar");
            $(".label_ly_sidebar_full").removeClass("pick_set_ly");
            $(".label_ly_sidebar_mini").addClass("pick_set_ly");
        });
    }
    handlesidebartoggle();
