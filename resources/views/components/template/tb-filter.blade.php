<div wire:ignore>
    <div class="row mb-3">
        <div class="col-sm-auto me-auto d-flex mb-2 btn-group-sm button_filter_grup div_btn_index_1 p-0">
            ...
            @if (!isset($no_button_status) || $no_button_status != '1')
                <div class="btn-group me-1">
            ...
            @if (!isset($no_button_export) || $no_button_export != '1')
                <div class="btn-group">
                    <button type="button" id="btn_print_excel" class="btn btn-primary rounded-1"
                        data-bs-toggle="dropdown" wire:loading.attr='disabled' aria-expanded="false"
                        data-toggle="tooltip" data-placement="bottom" title="Export Data">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <button id="filterExportExcel" type="button" class="dropdown-item"
                                wire:loading.attr='disabled' wire:click="export('excel')">
                                <span wire:loading.remove wire:target="export('excel')">Excel</span>
                                <span wire:loading wire:target="export('excel')">Downloading...</span>
                            </button>
                            <button id="filterExportPdf" type="button" class="dropdown-item"
                                wire:loading.attr='disabled' wire:click="export('pdf')">
