<td class="last-col sticky-col">
    <div class="btn-group btn-group-sm d-flex justify-content-center btn_index gap-1" id="baction">
        @if ($accessSubMenu->iedit == 1)
            <button wire:click="store({{ $li_data->id }})" id="tbedit" class="btn btn-info rounded-1 btn_index_edit"
                data-toggle="tooltip" data-placement="bottom" title="Edit Data"><i class="ti ti-edit fs-1"></i></button>
        @endif
