...
new class extends Component
{
    ...
    public function render()
    {
        ...
        $query = M_mt_divisi::detail('', 1, $this->filterSearch, $this->filterStatus);
        if ($this->sortField !== '') {
    ...
    public function store($id = "")
    {
        ...
        $this->id_header = $id;
        if ($this->id_header != "") {
            $data_render =  M_mt_divisi::detail($this->id_header);
    ...
    public function save()
    {
        ...
        // ==================================== VALID INPUT =======================================
        $this->valid_role = [
            'nama' => 'required|max:250|unique:mt_divisi,nama,' . $this->id_header,
            'ket' => 'max:500',
            'f_status' => 'required',
            'f_org' => 'required',
        ];
        ...
        if ($validator->errors()->count() > 0) {
            ...
            try {
                ...
                if ($this->id_header == "") {
                    ...
                    $execDB = M_mt_divisi::create($data_output);
                    ...
                    $execDB = M_mt_divisi::withTrashed()->findOrFail($this->id_header)->update($data_output);
    ...
    {
        try {
            $postDelete = M_mt_divisi::withTrashed()->findOrFail($id);
            $postDelete->delete();
