            ...
            <ul class="nav nav-tabs" role="tablist" wire:ignore>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $activeTab === 'tab4' ? 'active' : '' }}" data-bs-toggle="tab" href="#tab4"
                        role="tab" wire:click="setTab('tab4')" wire:transition>
                        <span>Periode</span>
                    </a>
                </li>
            </ul>
