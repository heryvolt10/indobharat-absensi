                        ...
                        <table id="tbindex_user" class="table tbview main-table table-hover ">
                            <thead class="fw-medium">
                                <tr>
                                    ...
                                    <th wire:click="sortBy('no_lembur')" style="cursor: pointer;">Tidak Ada Lembur
                                        @if ($sortField === 'no_lembur')
                                            {{ $sortDir === 'ASC' ? '↑' : '↓' }}
                                        @endif
                                    </th>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="form-check fs-3">
                                <input wire:model="i_no_lembur" class="form-check-input" type="checkbox"
                                    @if ($i_no_lembur == 1) checked @endif id="i_no_lembur">
                                <label class="form-check-label" for="i_no_lembur">Tidak Ada Lembur</label>
                            </div>
                            @error('i_no_lembur')
                                <div class="spanerror">{{ $message }}</div>
                            @enderror
