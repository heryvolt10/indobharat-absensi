...
new class extends Component
{
    ...
    public $id_header, $nama, $ket = '', $seq = '0', $icon, $f_status, $f_status_tag, $f_org, $f_org_tag;

    public $filterSearch = '', $filterStatus = '2', $listCount = '0';
    public $sortField = 'seq', $sortDir = 'ASC';
    ...
    public function render()
    {
        ...
        $query = M_users_menu::detail('', 1, $this->filterSearch, $this->filterStatus);
    ...
    public function store($id = "")
    {
        ...
        $this->id_header = $id;
        if ($this->id_header != "") {
            $data_render = M_users_menu::detail($this->id_header);
        ...
        if ($validator->errors()->count() > 0) {
            ...
            try {
                ...
                if ($this->id_header == "") {
                    ...
                    $execDB = M_users_menu::create($data_output);
                    ...
                    $execDB = M_users_menu::withTrashed()->findOrFail($this->id_header)->update($data_output);
    ...
    {
        $postDelete = M_users_menu::withTrashed()->findOrFail($id);
        $postDelete->delete();
