                        ...
                        <table id="tb_m_user" class="table tbview main-table table-hover table-md table-striped">
                            <thead class="fw-medium">
                                <tr>
                                    ...
                                    <th width="1%">No</th>
                                    <th wire:click="sortBy('menu')" style="cursor: pointer;">Menu @if ($sortField === 'menu')
                                            {{ $sortDir === 'ASC' ? '↑' : '↓' }}
                                        @endif
                                    </th>
                                    ...
                                    <th wire:click="sortBy('icon')" style="cursor: pointer;">Icon @if ($sortField === 'icon')
                                            {{ $sortDir === 'ASC' ? '↑' : '↓' }}
                                        @endif
                                    </th>
                                    <th wire:click="sortBy('url')" style="cursor: pointer;">Url @if ($sortField === 'url')
                                            {{ $sortDir === 'ASC' ? '↑' : '↓' }}
                                        @endif
                                    </th>
                                    <th>Keterangan</th>
            ...
            <div wire:show="showForm" wire:cloak>
                <form wire:submit="save" id="frmdata" class="frmform">
                    ...
                    <div class="border-bottom p-3 mb-4 d-flex gap-2 btn-group-lg">
                        <button wire:click="buttonBack" id="button_back" type="button"
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group">
                                <input wire:model="f_menu_tag" id="f_menu_tag" type="text"
                                    onchange="@this.set('f_menu_tag', this.value);"
                                    class="form-control onlyread @error('f_menu') is-invalid @enderror" readonly>
                                <input wire:model="f_menu" id="f_menu" name="f_menu" type="text"
                                    onchange="@this.set('f_menu', this.value);" class="form-control" hidden>
                                <button class="btn btn-success listdata" type="button" data-idinput="f_menu"
                                    data-poptitle="Menu" data-tblist="list_menu" data-type="0"><i
